...
/>
              `}),(0,n.jsx)(ey,{title:"React Node Content",commands:[{prompt:(0,n.jsx)("span",{style:{color:"#e0af68"},children:"Custom prompt"}),output:(0,n.jsx)("span",{style:{color:"#7dcfff"},children:"Custom output"})},{prompt:"Multiple React nodes",output:[(0,n.jsx)("div",{style:{color:"#f7768e"},children:"First node"},"1"),(0,n.jsx)("div",{style:{color:"#7aa2f7"},children:"Second node"},"2")]}],codeString:`
<Terminable
  commands={[
    {
...
/>
              `}),(0,n.jsx)(ey,{title:"Callbacks",commands:[{prompt:"onDone callback",output:"This command triggers onDone when finished"},{prompt:"onCopy callback",output:"Click this command to copy it"},{prompt:"onBeforeOutput callback",output:{content:"Output shown after onBeforeOutput fires",delay:1500,placeholder:"Preparing output..."}}],codeString:`
<Terminable
  commands={[
    {
...
/>
              `}),(0,n.jsx)(ey,{title:"Custom Colors",commands:[{prompt:"echo 'custom palette'",output:"Background, prompt and output colors are customizable"}],codeString:`
<Terminable
...
/>
              `}),(0,n.jsx)(ey,{title:"Complete Workflow",commands:[{prompt:"Starting system...",output:"System initialized",typingSpeed:80},{prompt:"Loading modules...",output:{placeholder:"Loading...",delay:2e3,content:"Modules loaded"}},{prompt:"Running diagnostics...",output:["CPU: OK","Memory: OK","Storage: OK"],onDone:()=>{}},{prompt:"System ready",output:(0,n.jsx)("span",{style:{color:"#9ece6a"},children:"All systems operational"})}],codeString:`
<Terminable
  commands={[
    {
